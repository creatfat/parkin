<?php
        ...
        while($obj = $result->fetch_assoc()){
          ...
          $index = array('note'=>$obj['note'], 'therapyID'=>$obj['therapyID'], 'patient_name' => $obj['username'], 'org' => $obj['organization'], 'therapy' => $obj['thl_name'], 'dosage' => $obj['Dosage'], 'medicine'=>$obj['med_name']);
          ...
          while($row_detail = $result_detail->fetch_assoc()){
            ...
            $index['dateTime'] = $row_detail['dateTime'];
              ...
              while($test = $test_detail->fetch_assoc()){
                $index['test_session_ID'] = $test['test_SessionID'];
                $index['dataURL'] = $test['DataURL'];
                array_push($patients_data2, $index);
