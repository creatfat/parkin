                          ...
                          <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%" style="text-align:center;vertical-align: middle;">
                              ...
                              <tbody>
                                <?php
                                  ...
                                  $i = 0;
                                  foreach($get_data as $val2){
                                    $i++;
                                ?>
                                <tr>
                                    <td><?php echo $i;?></td>
                                    <td><?php echo $val2['patient_name'];?></td>
                                    <td><?php echo $val2['org'];?></td>
                                    <td><?php echo $val2['therapy'];?></td>
                                    <td><?php echo $val2['medicine'];?></td>
                                    <td><?php echo $val2['dosage'];?></td>
                                    <td><?php echo $val2['testID'];?></td>
                                    <td><?php echo $val2['dateTime'];?></td>
                                    <td><?php echo $val2['note'];?></td>
                                    <td><?php
                                    
                                    echo '<a href="edit.php?patient_name='.$val2['patient_name'].'">edit</a>';
                                    ?></td>
                                    
                                   
                                    <td><a style="text-align:center;" href="http://plustor.ir/show/physicians/details.php/?data=<?php echo $val2['dataURL'];?>.csv" ><span class="mdi-24px mdi mdi-content-save"></span></a></td>  
                                </tr>
                          ...
                          <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%" style="text-align:center;vertical-align: middle;">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a style="text-align:center;" href="http://plustor.ir/show/physicians/diagrams.php/?data=<?php echo $val['dataURL'];?>.csv" ><span class="mdi-24px mdi mdi-content-save"></span></a></td>  
